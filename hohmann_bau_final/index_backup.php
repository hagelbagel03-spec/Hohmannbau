...
try {
    ...
    // Fallback for services and other data
    $services_data = [
...
<section class="section-professional bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-large text-gray-600 max-w-3xl mx-auto service-description-text" id="service-description-text" style="color: var(--service-description-color, #2d5016); font-weight: 500;">
